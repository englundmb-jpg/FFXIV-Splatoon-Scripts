...
public sealed class UCOB_Tenstrike_Accessible : SplatoonScript
{
    ...
    {
        Controller.RegisterElementFromCode("Tenstrike_Current", """
        {"Name":"CURRENT","Enabled":false,"radius":2.5,"Donut":0.35,"color":4278255360,"thicc":8.0,"FillStep":1.0,"tether":true,"LegacyFill":true,"overlayText":"SOUTH 3 SAFE","overlayBGColor":4278190080,"overlayTextColor":4294967295,"overlayFScale":1.5}
        """);
        OnReset();
    }
