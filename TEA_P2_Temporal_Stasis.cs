...
public class TEA_P2_Temporal_Stasis : SplatoonScript
{
    ...
    public override void OnMessage(string message)
    {
        if(message.Contains(Loc(
            en: "I am Alexander...the Creator. You...who would prove yourself worthy of your utopia...will be judged.",
            jp: "我はアレキサンダー……機械仕掛けの神なり……。",
            de: "Ich bin Alexander ... der Schöpfer. Nehmt mein letztes Urteil an, auf dass ihr ins Paradies geführt werdet ...")))
        {
    ...
    public override void OnTetherCreate(
        ...
        uint data5)
    {
        if(_isStartTemporalStasis)
            _shouldDisplayElement = true;
    }

    public override void OnTetherRemoval(
        uint source,
        uint data2,
        uint data3,
        uint data5)
    ...
    public override void OnUpdate()
    {
        ...
        if(cruiseChaser == null || !_isStartTemporalStasis)
            return;
